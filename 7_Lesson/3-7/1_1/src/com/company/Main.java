...
//            //Query query = em.createNativeQuery("SELECT c FROM Client c", Client.class);
//
...
//                //query = em.createNativeQuery("SELECT c FROM Client c WHERE c.email = :email", Client.class);
//
