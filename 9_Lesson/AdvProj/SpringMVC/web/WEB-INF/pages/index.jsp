...
<div class="container">
    ...
    <%--<img src="../resources/superkid_promo.jpg" alt="Не удалось отразить картинку" width="200" height="200">--%>

    <%--<img src="<c:url value="unnamed.jpg"/>" alt="Не удалось отразить картинку"/>--%>

    <%--<img src="<c:url value=""/>" alt="Не удалось отразить картинку"/>--%>
</div>
</body>
</html>